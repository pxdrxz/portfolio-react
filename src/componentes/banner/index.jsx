        ...
        <div className={styles.banner}>
            <div className={styles.apresentacao}>
                <h3 className={styles.titulo}>
                    Hello there, I'm Pedro Ferreira, a Software Developer, based in Brazil
                </h3>
                <p className={styles.paragrafo}>
                    In recent years, I have found myself in the field of technology, and since then, my focus has been on improving my skills as a full-stack developer, always seeking to broaden my knowledge and know how!
                </p>
                <h2 className={styles.contato}>
                    Contact Me
                </h2>
            </div>
        </div>
